...
const Navbar = () => {
  ...
  return (
    <section className='w-full sticky top-0 z-50 backdrop-blur-md bg-black/40 border-b border-white/5'>
      <div className='w-full max-w-5xl px-4 py-4 flex justify-between items-center mx-auto'>

        {/* Logo */}
        <Link to="/">
          <h3 className='text-xl font-bold tracking-wide text-white'>ThinkLikeSadique</h3>
        </Link>
        ...
        <ul className='hidden md:flex items-center gap-6 text-gray-400'>
          ...
          <li>
            <a
              ...
              className='hover:text-white transition-all duration-200 flex items-center'
            >
      ...
      {isOpen && (
        <div className='md:hidden bg-black border-t border-gray-800'>
          <ul className='flex flex-col items-center gap-4 py-6 text-gray-400'>
