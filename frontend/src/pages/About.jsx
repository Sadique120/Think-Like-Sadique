        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mb-16 space-y-5">
            <p className="text-slate-300 text-base sm:text-lg leading-8">
              Hey — I'm <span className="text-white font-semibold">Sadique</span>, a 3rd year Computer Engineering student and MERN stack developer. I built ThinkLikeSadique because most DSA content skips the part that actually matters — <span className="text-white font-semibold">how you think</span> before you code.
            </p>
