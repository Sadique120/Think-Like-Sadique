...
🔗 **Live** → [https://think-like-Sadique.vercel.app](https://think-like-Sadique.vercel.app)

---

## 🧠 What This Is

ThinkLikeSadique is a full-stack DSA learning journal. Every post documents a real problem-solving journey:
...
```bash
git clone https://github.com/piratesofsi/ThinkLikeSadique.git
cd ThinkLikeSadique/frontend
npm install
npm run dev
```
